<template>
    <form method="post" @submit.prevent="submit" @keydown="clearErrors($event.target.name)">
        ...
        <div class="form-group has-feedback" :class="{ 'has-error': form.errors.has('email') }">
            <input type="email" class="form-control" placeholder="a" name="email"
        ...
        <div class="form-group has-feedback" :class="{ 'has-error': form.errors.has('password') }">
            <input type="password" class="form-control" placeholder="b"
        ...
        <div class="form-group has-feedback">
            <input type="password" class="form-control" placeholder="c"
        ...
        <div class="row">
            ...
            <div class="col-xs-8">
                <button type="submit" class="btn btn-primary btn-block btn-flat" :disabled="form.errors.any()"><i
                        v-if="form.submitting" class="fa fa-refresh fa-spin"></i> Reset password
                </button>
            </div><!-- /.col -->
            <div class="col-xs-2">
            </div><!-- /.col -->
